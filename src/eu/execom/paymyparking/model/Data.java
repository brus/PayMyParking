...
public class Data {
	...
	private Boolean confirmParkingPayment;
	...
	public Boolean getConfirmParkingPayment() {
		return confirmParkingPayment;
	}

	public void setConfirmParkingPayment(Boolean confirmParkingPayment) {
		this.confirmParkingPayment = confirmParkingPayment;
	}
